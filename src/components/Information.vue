...
<div>
  <div class="text">
    <h2 v-bind:style="{opacity: 1-(0.7*(percent/100))}">The Problem</h2>
    <p v-bind:style="{opacity: 1-(0.7*(percent/100))}">
    ...
    <h2 v-bind:style="{opacity: percent/100}">The Solution</h2>
    <p v-bind:style="{opacity: percent/100}">
